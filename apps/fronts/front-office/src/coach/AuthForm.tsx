  ...
  return (
    <Center maxW="container.sm" mx="auto" sx={{minH: "100vh"}}>
      <VStack w="full" spacing="6">
        <Heading>SportLog - Connexion Coach</Heading>
        <Card width="full">
          <CardBody>
            <VStack spacing="6">
              <FormControl>
              ...
              <HStack>
                <Button colorScheme="green" variant="outline" size="lg">Se connecter</Button>
                <Button colorScheme="green" size="lg">S'inscrire</Button>
              </HStack>
            </VStack>
          </CardBody>
        </Card>

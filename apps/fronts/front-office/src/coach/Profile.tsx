        ...
        <VStack w="full" spacing="8">
          ...
          <VStack w="full" spacing="6" align="start">
            <Box>
              ...
              <Box>
                <Text fontSize="lg">
                  Nom : {coach.firstname} {coach.lastname.toLocaleUpperCase()}
                </Text>
                <Text fontSize="lg">Sexe : {coach.gender}</Text>
                <Text fontSize="lg">
                  Date de naissance :{" "}
                  {coach.birthdate.toLocaleDateString("fr-FR")}
                </Text>
                <Text fontSize="lg">Adresse mail : {coach.mail}</Text>
                <Text fontSize="lg">
                  Numéro de téléphone : {coach.phoneNumber}
                </Text>
              </Box>
            </Box>
            <Box>
              ...
              <Box>
                <Text fontSize="lg">
                  Poste : {coach.currentSituation.position}
                </Text>
                <Text fontSize="lg">
                  Club actuel : {coach.currentSituation.club}
                </Text>
                <Text fontSize="lg">
                  Division : {coach.currentSituation.division}
                </Text>
              </Box>
              ...
              <Box>
                <Box>
                  <Link href={coach.links.proResume} fontSize="lg" isExternal>
                    CV Professionel
                  </Link>
                </Box>
                <Box>
                  <Link href={coach.links.sportResume} fontSize="lg" isExternal>
                    CV Sportif
                  </Link>
                </Box>
              </Box>

  ...
  return (
    <Center maxW="container.lg" mx="auto" pt="14">
      <VStack w="full" spacing="4">
        <Heading>SportLog - Inscription Joueur</Heading>
        {actualCard === "card1" && (
          <SignUpFormCard1 onNextClickStep={onCard1NextStepClick} />
        )}
        {actualCard === "card2" && (
          <SignUpFormCard2 onBeforeButtonClick={onCard2PreviousStepClick} />
        )}
      </VStack>
    </Center>
  );
